        ...
        <div class="surve-request relative">
          <div>
            <h3 class="survey-title text-h5 font-weight-bold text-N100">
              {{ $t("UniversityMessagesRegistration") }}
            </h3>
            <v-sheet
              color="transparent"
              class="back-to-home"
          ...
          <!-- #########[STEPERS]########  -->
          <!-- <StaticSectionsStepersProgress></StaticSectionsStepersProgress> -->
          <v-sheet
            color="transparent"
            ...
            <v-card width="610px" class="card" elevation="2">
              <v-container>
                ...
                <v-form ref="form" class="mt-5">
                  ...
                  <v-text-field
                    v-model="university"
                    :rules="[rules.required, rules.university]"
                    :label="$t('university')"
                    required
                    variant="outlined"
                  ></v-text-field>
                  ...
                  <v-text-field
                    v-model="college"
                    :rules="[rules.required, rules.college]"
                    :label="$t('college')"
                    required
                    variant="outlined"
                  ></v-text-field>
                  ...
                  <v-select
                    ...
                    :rules="[rules.required, rules.messageLevel]"
